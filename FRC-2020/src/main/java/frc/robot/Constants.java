...
public static final int X3D_LEFT_JOYSTICK_ID = 0, // Joysticks IDs
  ...
  CLIMB_AXIS_ID = GAMEPAD_AXIS_LEFT_Y, //climb axis
...
public static final int SHOOT_FIRE_RIGHT_TALON_SRX_ID = 1,
  SHOOT_FIRE_LEFT_TALON_SRX_ID = 2,
  SHOOT_LOAD_TALON_SRX_ID = 3,
  SHOOT_PIVOT_TALON_SRX_ID = 4,
  SHOOT_INTAKE_TALON_SRX_ID = 5,
  SHOOT_PIVOT_POTENTIOMETER_ID = 6;
