...
public static final int CONTROL_PANEL_MANIPULATOR_TALON_SRX_ID = 18,
  CONTROL_PANEL_ROTATOR_TALON_SRX_ID = 19,
  CONTROL_PANEL_LIMIT_SWITCH_INPUT_ID =1,
  CONTROL_PANEL_ROTATION_ENCODER_CHANNELA_ID = 4,
  CONTROL_PANEL_ROTATION_ENCODER_CHANNELB_ID = 5,
