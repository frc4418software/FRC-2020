...
class PythonReflectiveHSVTracker:
    ...
    ## Constructor
    def __init__(self):
        global nopeString, HSV_low_thresh, HSV_high_thresh, HSV_erode_its, HSV_dilate_its, width_min, height_min
    ...
    def processNoUSB(self, inframe):
        ...
        #error: OpenCV(4.1.1) /lab/itti/jevois/software/jevois-sdk/out/sun8iw5p1/linux/common/buildroot/'
        #error: OpenCV(4.1.1) /lab/itti/jevois/software/jevois-sdk/out/sun8iw5p1/linux/common/buildroot/'

        contours, hierarchy = cv2.findContours(inimg, mode=cv2.RETR_TREE, method=cv2.CHAIN_APPROX_SIMPLE)
    ...
    def process(self, inframe, outframe):
        get_inframe = inframe.getCvBGR()
        Pipelin(inimg=get_inframe, has_out_frame=True)
